...
void roomdet()
{
    printf("1) DELUXE ROOM: Rs 1500 per person per night. \n SINGLE OR DOUBLY OCCUPIED \n AMENITIES \n BREAKFAST INCLUDED \n AC \n TV \n FREE WIFI \n QUEEN SIZED BED \n");
    printf("2) SUPER DELUXE ROOM: Rs 2000 per person per night. \n SINGLE OR DOUBLY OCCUPIED \n AMENITIES \n BREAKFAST INCLUDED \n AC \n TV \n FREE WIFI \n KING SIZED BED \n EVENING SPA \n");
    printf("3) DELUXE SUITE: Rs 2500 per person per night. \n DOUBLY OCCUPIED \n AMENITIES \n BREAKFAST AND SNACKS INCLUDED \n AC \n TV \n FREE WIFI \n 2 KING SIZED BEDS \n ALL DAY SPA & FREE ACCESS TO CLUB HOUSE \n");
}
void addroom()
{
    int s1 = 0;
    unsigned long long int mobi;
    int extra;
    struct details *temp;
    ...
    do
    {
        ...
        scanf("%llu", &mobi);
        if (mobi < 9999999999 && mobi > 6000000000)
        {
            temp->mobile = mobi;
            s1 = 1;
        }
    ...
    if (extra <= 2)
    {
        ...
        scanf("%d", &time);
        temp->iduration = time;
        printf("Your room is booked for %d days\n", time);
...
void checkout()
{
    ...
    if (temp->eroomtype == 3)
        printf("COST PER PERSON PER NIGHT IS ? 1150 \n");
    if (temp->eduration > 10000000)
    {
        printf("ENTENDED DURATION 0 \n");
    }
    else
    {
        printf("EXTENDED DURATION %d \n", temp->eduration);
    ...
    if (temp->resbill > 10000000)
    {
        printf("BILL OF RESTAURANT IS  0 \n");
        temp->resbill = 0;
    }
    else
    {
        printf("BILL OF RESTRAUNT IS %d \n", temp->resbill);
    }
